...
public class StringUtil {
	...
	public static String replace(String text, String key, Date dateValue) {
		avoidNPE(text);
		avoidNPE(key);
		return text.replaceAll(key, toString(dateValue) );
	}
	...
	private static String toString(Date dateValue) {
		SimpleDateFormat formatador = new SimpleDateFormat("dd/MM/yyyy");
		return formatador.format(dateValue);
	}
